                    ...
                    <div class="flex px-2 flex-row relative">
                      <div class="absolute left-5 top-3 px-2 py-2 rounded-full bg-blue-700 text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d=" M21 21l-6-6m2-5a7 7 0
                        ...
                        <div
                            ...
                            <div class="py-1">
                                <div class="w-28 grid grid-cols-3 gap-2 ml-2">
                                    ...
                                    <input x-model.number="item.qty" :max="item.maxQty" @input="checkQty(item)"
                                        type="text"
        ...
        <div x-show="isShowModalReceipt" class="w-96 rounded-3xl bg-white shadow-xl overflow-hidden z-10"
            ...
            <div id="receipt-content" class="text-left w-full text-sm p-6 overflow-auto">
                <div class="text-center">
                    ...
                    <h2 class="text-xl font-semibold">Cafe Ghibli</h2>
                    <p> JL Ghibli Raya No 90</p>
                </div>
