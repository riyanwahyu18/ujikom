...
@section('content')
    <section class="py-5 bg-white rounded">
        <div class="container">
            <h1 class="display-4 fw-bold text-center">Order Details Ghibli Cafe</h1>
            <div class="row">
                <div class="col-12">
                        ...
                        <form action="{{ route('pos.update', $order->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="cash_received" id="cash_received" class="form-control"
                                    min="{{ $order->order_amount }}" required>
                            </div>
                ...
                @else
                    ...
                    <div class="col-12 text-center">
                        <a href="{{ route('print', $order->id) }}" target="_blank" class="btn btn-success">Print
                            Receipt</a>
                    </div>
                @endif
            </div>
